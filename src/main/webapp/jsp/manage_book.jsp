...
<%
  List<Book> books = new BookDAO().getAllBooks(); // You can customize this based on your DAO structure
%>
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <table class="table table-bordered table-striped mt-4">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <a href="edit_book.jsp?id=<%= book.getBookId() %>" class="btn btn-warning btn-sm">Edit</a>
				<a href="<%= request.getContextPath() %>/DeleteBookServlet?id=<%= book.getBookId() %>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
              </tr>
              <% } %>
            </tbody>
